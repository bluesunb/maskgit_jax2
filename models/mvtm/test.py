...
#
# def im2col(data_im, channels, height, width, output_height, output_width,
...
#                     data_col[c_col, h_col, w_col] = data_im[
#                         c_im, h_im, w_im]
#     return data_col
#
# def col2im(data_col, channels, height, width, output_height, output_width,
#            kernel_h, kernel_w, pad_h, pad_w, stride_h, stride_w,
#            dilation_h, dilation_w):
#     data_im = np.zeros((channels, height, width))
#
#     height_col = output_height
#     width_col = output_width
#     channels_col = channels * kernel_h * kernel_w
...
#
#                 if 0 <= h_im < height and 0 <= w_im < width:
#                     data_im[c_im, h_im, w_im] += data_col[
#                         c_col, h_col, w_col]
#     return data_im

def tmp(x: jp.ndarray, p:int):


# def tmp(x: jp.ndarray, p: int):
#     n = x.shape[0]
#     x = jp.arange(n)[:p * n // p].reshape(-1, p)
